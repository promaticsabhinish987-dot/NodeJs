...
# Preventing Duplicate Payments (MongoDB)
...
Preventing duplicate payments is a classic idempotency problem in distributed systems.

The objective is:

**No matter how many times the request is sent, only one payment should be created.**
